...
gitlab_rails['omniauth_providers'] = [
  {
    'name' => 'oauth2_generic',
    'app_id' => 'git',
    'app_secret' => 'b3783064-59da-4885-b903-6014cc836017',
    'args' => {
      client_options: {
        'site' => 'https://192.168.3.173', # including port if necessary
        'authorize_url' => '/auth/realms/opck/protocol/openid-connect/auth',
        'token_url' => '/auth/realms/opck/protocol/openid-connect/token',
        'user_info_url' => '/auth/realms/opck/protocol/openid-connect/userinfo'
      },
      ...
      name: 'openid_connet', # display name for this strategy
...
#        'name' => 'oauth2_generic',
#        'app_id' => 'account',
#        'app_secret' => '8c32d303-1b27-4fac-9a68-1c077d42a0da',
#        'args' => {
#        client_options: { 
#                'site' => 'https://192.168.3.173', # including port if necessary
#                'user_info_url' => '/auth/realms/opck/protocol/openid-connect/userinfo',
...
#        attributes: { name: 'username', nickname: 'nickName'} # if the nickname attribute of a user is called 'username'
#      },
#      name: 'Name', # display name for this strategy
#      strategy_class: "OmniAuth::Strategies::OAuth2Generic" # Devise-specific config option Gitlab uses to find renamed strategy
#     }
# }
#]
...
gitlab_rails['gitlab_email_from'] = 'opck@sinux.com.cn'
gitlab_rails['gitlab_email_display_name'] = 'opck'
gitlab_rails['gitlab_email_reply_to'] = 'noreplay@sinux.com.cn'
gitlab_rails['smtp_enable'] = true
gitlab_rails['smtp_address'] = "smtp.qiye.aliyun.com"
gitlab_rails['smtp_port'] = 465
gitlab_rails['smtp_user_name'] = "opck@sinux.com.cn"
gitlab_rails['smtp_password'] = "Sinux2020"
